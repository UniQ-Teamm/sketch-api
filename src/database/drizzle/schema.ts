...
export const userToken = pgTable(
  ...
  table => {
    return {
      idxUserTokenToken: index('idx_user_token_token').using(
        'btree',
        table.token,
      ),
      idxUserTokenUserId: index('idx_user_token_user_id').using(
        'btree',
        table.userId,
      ),
    };
...
export const user = pgTable(
  ...
  table => {
    return {
      ...
      unqUserSocialId: uniqueIndex('unq_user_social_id').using(
        'btree',
        table.socialId,
      ),
    };
